...
(cl:defmethod cl:initialize-instance :after ((m <GPSInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GPSInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaguar4x4_2014-msg:<GPSInfo> is deprecated: use jaguar4x4_2014-msg:GPSInfo instead.")))
...
(cl:defmethod time-val ((m <GPSInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:time-val is deprecated.  Use jaguar4x4_2014-msg:time instead.")
  (time m))

(cl:ensure-generic-function 'date-val :lambda-list '(m))
(cl:defmethod date-val ((m <GPSInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:date-val is deprecated.  Use jaguar4x4_2014-msg:date instead.")
  (date m))
...
(cl:defmethod latitude-val ((m <GPSInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:latitude-val is deprecated.  Use jaguar4x4_2014-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <GPSInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:longitude-val is deprecated.  Use jaguar4x4_2014-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'vog-val :lambda-list '(m))
(cl:defmethod vog-val ((m <GPSInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:vog-val is deprecated.  Use jaguar4x4_2014-msg:vog instead.")
  (vog m))

(cl:ensure-generic-function 'cog-val :lambda-list '(m))
(cl:defmethod cog-val ((m <GPSInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:cog-val is deprecated.  Use jaguar4x4_2014-msg:cog instead.")
  (cog m))

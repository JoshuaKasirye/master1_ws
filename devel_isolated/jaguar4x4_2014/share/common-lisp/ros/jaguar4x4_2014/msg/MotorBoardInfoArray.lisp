...
(cl:defclass <MotorBoardInfoArray> (roslisp-msg-protocol:ros-message)
  ((motorBoardInfo
    ...
    :type (cl:vector jaguar4x4_2014-msg:MotorBoardInfo)
   :initform (cl:make-array 0 :element-type 'jaguar4x4_2014-msg:MotorBoardInfo :initial-element (cl:make-instance 'jaguar4x4_2014-msg:MotorBoardInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MotorBoardInfoArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorBoardInfoArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaguar4x4_2014-msg:<MotorBoardInfoArray> is deprecated: use jaguar4x4_2014-msg:MotorBoardInfoArray instead.")))

(cl:ensure-generic-function 'motorBoardInfo-val :lambda-list '(m))
(cl:defmethod motorBoardInfo-val ((m <MotorBoardInfoArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:motorBoardInfo-val is deprecated.  Use jaguar4x4_2014-msg:motorBoardInfo instead.")
  (motorBoardInfo m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MotorBoardInfoArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'motorBoardInfo)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'jaguar4x4_2014-msg:MotorBoardInfo))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorBoardInfoArray>)))
  ...
  "jaguar4x4_2014/MotorBoardInfoArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorBoardInfoArray)))
  "Returns string type for a message object of type 'MotorBoardInfoArray"
  "jaguar4x4_2014/MotorBoardInfoArray")

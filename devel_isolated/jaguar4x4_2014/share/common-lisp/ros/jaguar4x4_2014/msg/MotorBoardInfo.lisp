...
(cl:defmethod cl:initialize-instance :after ((m <MotorBoardInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorBoardInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaguar4x4_2014-msg:<MotorBoardInfo> is deprecated: use jaguar4x4_2014-msg:MotorBoardInfo instead.")))
...
(cl:defmethod status-val ((m <MotorBoardInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:status-val is deprecated.  Use jaguar4x4_2014-msg:status instead.")
  (status m))

(cl:ensure-generic-function 'temp1-val :lambda-list '(m))
(cl:defmethod temp1-val ((m <MotorBoardInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:temp1-val is deprecated.  Use jaguar4x4_2014-msg:temp1 instead.")
  (temp1 m))

(cl:ensure-generic-function 'temp2-val :lambda-list '(m))
(cl:defmethod temp2-val ((m <MotorBoardInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:temp2-val is deprecated.  Use jaguar4x4_2014-msg:temp2 instead.")
  (temp2 m))

(cl:ensure-generic-function 'temp3-val :lambda-list '(m))
(cl:defmethod temp3-val ((m <MotorBoardInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:temp3-val is deprecated.  Use jaguar4x4_2014-msg:temp3 instead.")
  (temp3 m))

(cl:ensure-generic-function 'volMain-val :lambda-list '(m))
(cl:defmethod volMain-val ((m <MotorBoardInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:volMain-val is deprecated.  Use jaguar4x4_2014-msg:volMain instead.")
  (volMain m))

(cl:ensure-generic-function 'vol12V-val :lambda-list '(m))
(cl:defmethod vol12V-val ((m <MotorBoardInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:vol12V-val is deprecated.  Use jaguar4x4_2014-msg:vol12V instead.")
  (vol12V m))

(cl:ensure-generic-function 'vol5V-val :lambda-list '(m))
(cl:defmethod vol5V-val ((m <MotorBoardInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:vol5V-val is deprecated.  Use jaguar4x4_2014-msg:vol5V instead.")
  (vol5V m))

(cl:ensure-generic-function 'dinput-val :lambda-list '(m))
(cl:defmethod dinput-val ((m <MotorBoardInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:dinput-val is deprecated.  Use jaguar4x4_2014-msg:dinput instead.")
  (dinput m))

(cl:ensure-generic-function 'doutput-val :lambda-list '(m))
(cl:defmethod doutput-val ((m <MotorBoardInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:doutput-val is deprecated.  Use jaguar4x4_2014-msg:doutput instead.")
  (doutput m))

(cl:ensure-generic-function 'ack-val :lambda-list '(m))
(cl:defmethod ack-val ((m <MotorBoardInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:ack-val is deprecated.  Use jaguar4x4_2014-msg:ack instead.")
  (ack m))

...
(cl:defmethod cl:initialize-instance :after ((m <MotorData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaguar4x4_2014-msg:<MotorData> is deprecated: use jaguar4x4_2014-msg:MotorData instead.")))
...
(cl:defmethod motorPower-val ((m <MotorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:motorPower-val is deprecated.  Use jaguar4x4_2014-msg:motorPower instead.")
  (motorPower m))

(cl:ensure-generic-function 'encoderPos-val :lambda-list '(m))
(cl:defmethod encoderPos-val ((m <MotorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:encoderPos-val is deprecated.  Use jaguar4x4_2014-msg:encoderPos instead.")
  (encoderPos m))

(cl:ensure-generic-function 'encoderVel-val :lambda-list '(m))
(cl:defmethod encoderVel-val ((m <MotorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:encoderVel-val is deprecated.  Use jaguar4x4_2014-msg:encoderVel instead.")
  (encoderVel m))

(cl:ensure-generic-function 'encoderDiff-val :lambda-list '(m))
(cl:defmethod encoderDiff-val ((m <MotorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:encoderDiff-val is deprecated.  Use jaguar4x4_2014-msg:encoderDiff instead.")
  (encoderDiff m))

(cl:ensure-generic-function 'motorTemp-val :lambda-list '(m))
(cl:defmethod motorTemp-val ((m <MotorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:motorTemp-val is deprecated.  Use jaguar4x4_2014-msg:motorTemp instead.")
  (motorTemp m))

(cl:ensure-generic-function 'motorCurrent-val :lambda-list '(m))
(cl:defmethod motorCurrent-val ((m <MotorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:motorCurrent-val is deprecated.  Use jaguar4x4_2014-msg:motorCurrent instead.")
  (motorCurrent m))

...
(cl:in-package jaguar4x4_2014-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <IMUData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IMUData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jaguar4x4_2014-msg:<IMUData> is deprecated: use jaguar4x4_2014-msg:IMUData instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:header-val is deprecated.  Use jaguar4x4_2014-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'seq-val :lambda-list '(m))
(cl:defmethod seq-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:seq-val is deprecated.  Use jaguar4x4_2014-msg:seq instead.")
  (seq m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:yaw-val is deprecated.  Use jaguar4x4_2014-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:pitch-val is deprecated.  Use jaguar4x4_2014-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:roll-val is deprecated.  Use jaguar4x4_2014-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'gyro_x-val :lambda-list '(m))
(cl:defmethod gyro_x-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:gyro_x-val is deprecated.  Use jaguar4x4_2014-msg:gyro_x instead.")
  (gyro_x m))

(cl:ensure-generic-function 'gyro_y-val :lambda-list '(m))
(cl:defmethod gyro_y-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:gyro_y-val is deprecated.  Use jaguar4x4_2014-msg:gyro_y instead.")
  (gyro_y m))

(cl:ensure-generic-function 'gyro_z-val :lambda-list '(m))
(cl:defmethod gyro_z-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:gyro_z-val is deprecated.  Use jaguar4x4_2014-msg:gyro_z instead.")
  (gyro_z m))

(cl:ensure-generic-function 'accel_x-val :lambda-list '(m))
(cl:defmethod accel_x-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:accel_x-val is deprecated.  Use jaguar4x4_2014-msg:accel_x instead.")
  (accel_x m))

(cl:ensure-generic-function 'accel_y-val :lambda-list '(m))
(cl:defmethod accel_y-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:accel_y-val is deprecated.  Use jaguar4x4_2014-msg:accel_y instead.")
  (accel_y m))

(cl:ensure-generic-function 'accel_z-val :lambda-list '(m))
(cl:defmethod accel_z-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:accel_z-val is deprecated.  Use jaguar4x4_2014-msg:accel_z instead.")
  (accel_z m))

(cl:ensure-generic-function 'comp_x-val :lambda-list '(m))
(cl:defmethod comp_x-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:comp_x-val is deprecated.  Use jaguar4x4_2014-msg:comp_x instead.")
  (comp_x m))

(cl:ensure-generic-function 'comp_y-val :lambda-list '(m))
(cl:defmethod comp_y-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:comp_y-val is deprecated.  Use jaguar4x4_2014-msg:comp_y instead.")
  (comp_y m))

(cl:ensure-generic-function 'comp_z-val :lambda-list '(m))
(cl:defmethod comp_z-val ((m <IMUData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jaguar4x4_2014-msg:comp_z-val is deprecated.  Use jaguar4x4_2014-msg:comp_z instead.")
  (comp_z m))

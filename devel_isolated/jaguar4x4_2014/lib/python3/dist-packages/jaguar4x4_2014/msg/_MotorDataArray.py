...
"""autogenerated by genpy from jaguar4x4_2014/MotorDataArray.msg. Do not edit."""
import codecs
import sys
...
class MotorDataArray(genpy.Message):
  ...
  _type = "jaguar4x4_2014/MotorDataArray"
...
"""
  __slots__ = ['motorData']
  _slot_types = ['jaguar4x4_2014/MotorData[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.motorData:
        ...
        _x = val1
        buff.write(_get_struct_4q2f().pack(_x.motorPower, _x.encoderPos, _x.encoderVel, _x.encoderDiff, _x.motorTemp, _x.motorCurrent))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = jaguar4x4_2014.msg.MotorData()
        _v3 = val1.header
        start = end
        end += 4
        ...
        (_x.motorPower, _x.encoderPos, _x.encoderVel, _x.encoderDiff, _x.motorTemp, _x.motorCurrent,) = _get_struct_4q2f().unpack(str[start:end])
...
def _get_struct_2I():
    ...
    return _struct_2I
_struct_4q2f = None
def _get_struct_4q2f():
    global _struct_4q2f
    if _struct_4q2f is None:
